...
export default function Login() {
  ...
  function cadastro() { navigate("/cadastro"); }
          ...
          <div className="grid w-full grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative hidden h-full flex-col justify-between bg-zinc-900 p-10 text-white md:flex">
              <div className="absolute inset-0">
                <img className="h-full w-full object-cover" src="/utfpr.jpg" alt="utfpr" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/20" />
              </div>
              <div className="relative z-20 flex items-center gap-3 text-lg font-medium">
                <span className="w-full md:w-1/6 lg:w-1/6 h-auto"><img src="/quiz.png" alt="Quiz UTFPR"/></span>
              </div>
              <div className="relative z-20 mt-auto">
                <p className="text-2xl font-semibold italic">{t('login_frase_esq')}</p>
              </div>
            </div>
              ...
              <div className="mx-auto flex w-full max-w-md flex-col justify-center space-y-6">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <button className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-zinc-300 px-5 font-bold hover:bg-zinc-100 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800">
                ...
                <p className="px-8 text-center text-sm text-zinc-600 dark:text-zinc-400">
                  {t('login_sem_conta')}{" "}
                  <button onClick={cadastro} className="hover:underline font-bold underline hover:text-primary">
                    {t('login_cadastre_se')}
                  </button>
                </p>
              </div>
